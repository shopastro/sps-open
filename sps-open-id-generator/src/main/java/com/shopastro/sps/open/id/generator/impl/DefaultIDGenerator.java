...
import com.shopastro.sps.open.id.generator.utils.DateUtils;
...
public class DefaultIDGenerator implements IDGenerator, InitializingBean {
    ...
    public DefaultIDGenerator(UidProperties uidProperties) {
    ...
    public void afterPropertiesSet() throws Exception {
        try {
            ...
            LOGGER.error("AssignWorkerIdError", e);
        }
    }
