...
/**
 * StateMachine. Notice: this class instance if Thread Safe, each state machine config only need one instance object in VM;
 *
...
public interface StateMachine<S, E, C> extends Visitable {
    ...
    void setInitStates(Set<S> initStates);

    void setTerminalStates(Set<S> terminalStates);
